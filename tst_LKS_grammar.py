...
"""tst_LKS_grammar.py - runs the unit tests for the LKS-grammar
"""
...
if __name__ == '__main__':
    ...
    if args.scripts:
        dsl.create_scripts(os.path.join(scriptdir, 'LKS.ebnf'))
    ...
    if arg.endswith('.ebnf'):
        ...
        recompile_grammar(os.path.join(scriptdir, 'LKS.ebnf'),
                          force=False)
        sys.path.append('.')
        from LKSParser import parsing, ASTTransformation, \
